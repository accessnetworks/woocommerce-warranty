							...
							<div class="inline-edit-col">
									...
									<span class="input-text-wrap">
										<select name="included_warranty_length[<?php echo $_product->get_id(); ?>]" class="select short included-warranty-length warranty_<?php echo $_product->get_id(); ?>" id="included_warranty_length_<?php echo $_product->get_id(); ?>">
											...
											if ( $warranty['type'] == 'included_warranty' && $warranty['length'] == 'limited' ) {
												echo 'selected';}
											?>
											 value="limited"><?php _e( 'Limited', 'wc_warranty' ); ?></option>
										</select>
									</span>
								</label>
								<br class="clear" />
								...
								<div class="inline-edit-group included-form" id="limited_warranty_row_<?php echo $_product->get_id(); ?>">
									<label class="alignleft">
										...
										<span class="input-text-wrap">
											<input type="text" class="input-text sized warranty_<?php echo $_product->get_id(); ?>" size="3" name="limited_warranty_length_value[<?php echo $_product->get_id(); ?>]" value="
																										   <?php
									...
									<label class="alignleft">
										<select name="limited_warranty_length_duration[<?php echo $_product->get_id(); ?>]" class="warranty_<?php echo $_product->get_id(); ?>" style="vertical-align: baseline;">
											...
											if ( $warranty['type'] == 'included_warranty' && $warranty['duration'] == 'years' ) {
												echo 'selected';}
											?>
											 value="years"><?php _e( 'Years', 'wc_warranty' ); ?></option>
										</select>
									</label>
								</div>
										...
										<input type="checkbox" name="addon_no_warranty[<?php echo $_product->get_id(); ?>]" id="addon_no_warranty" value="yes" 
																								  <?php
																									if ( isset( $warranty['no_warranty_option'] ) && $warranty['no_warranty_option'] == 'yes' ) {
																										echo 'checked';}
																									?>
										 class="checkbox warranty_<?php echo $_product->get_id(); ?>" />
									...
									<table class="widefat">
										...
										if ( isset( $warranty['addons'] ) ) {
											...
											<tr>
												...
												<td valign="middle">
													<input type="text" class="input-text sized warranty_<?php echo $_product->get_id(); ?>" size="2" name="addon_warranty_length_value[<?php echo $_product->get_id(); ?>][]" value="
																												   <?php
																													if ( $warranty['type'] == 'addon_warranty' ) {
																														echo esc_attr( $addon['value'] );}
																													?>
													" />
									...
									<div class="inline-edit-col">
										...
										<div class="inline-edit-group included-form" id="limited_warranty_row_<?php echo $child; ?>">
											<label class="alignleft">
												<span class="title"><?php _e( 'Length', 'wc_warranty' ); ?></span>
												<span class="input-text-wrap">
													<input type="text" class="input-text sized warranty_<?php echo $child; ?>" size="3" name="limited_warranty_length_value[<?php echo $child; ?>]" value="
																												   <?php
																													if ( $warranty['type'] == 'included_warranty' ) {
																														echo $warranty['value'];}
																													?>
												...
												<input type="checkbox" name="addon_no_warranty[<?php echo $child; ?>]" id="addon_no_warranty" value="yes" 
																										  <?php
																											if ( isset( $warranty['no_warranty_option'] ) && $warranty['no_warranty_option'] == 'yes' ) {
																												echo 'checked';}
																											?>
												 class="checkbox warranty_<?php echo $child; ?>" />
												<span class="checkbox-title"><?php _e( '"No Warranty" option', 'wc_warranty' ); ?></span>
											</label>
										</div>
											...
											<table class="widefat">
												...
												if ( isset( $warranty['addons'] ) ) {
													...
													<tr>
														...
														<td valign="middle">
															<input type="text" class="input-text sized warranty_<?php echo $child; ?>" size="2" name="addon_warranty_length_value[<?php echo $child; ?>][]" value="
																														   <?php
																															if ( $warranty['type'] == 'addon_warranty' ) {
																																echo esc_attr( $addon['value'] );}
																															?>
