					...
					<td class="colspanchange" colspan="2">
								...
								<div class="inline-edit-group included-form" id="limited_warranty_row_<?php echo $category_id; ?>">
									<label class="alignleft">
										<span class="title"><?php _e( 'Length', 'wc_warranty' ); ?></span>
													<span class="input-text-wrap">
														<input type="text" class="input-text sized warranty_<?php echo $category_id; ?>" size="3" name="category_limited_warranty_length_value[<?php echo $category_id; ?>]" value="
																													   <?php
						...
						<fieldset class="inline-edit-col-left">
							<div class="inline-edit-col addon-form">
								...
								<div class="inline-edit-group">
									<label class="alignleft">
										<input type="checkbox" name="category_addon_no_warranty[<?php echo $category_id; ?>]" id="addon_no_warranty" value="yes" 
																										   <?php
																											if ( isset( $warranty['no_warranty_option'] ) && $warranty['no_warranty_option'] == 'yes' ) {
																												echo 'checked';}
																											?>
										 class="checkbox warranty_<?php echo $category_id; ?>" />
									...
									<table class="widefat">
										...
										if ( isset( $warranty['addons'] ) ) {
											...
											<tr>
												...
												<td valign="middle">
													<input type="text" class="input-text sized warranty_<?php echo $category_id; ?>" size="2" name="category_addon_warranty_length_value[<?php echo $category_id; ?>][]" value="
																												   <?php
