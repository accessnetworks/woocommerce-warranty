...
<div id="warranty_product_data" class="panel woocommerce_options_panel">
	...
	<div class="options_group grouping show_if_included_warranty hide_if_control_variations">
		...
		<p class="form-field limited_warranty_length_field">
			...
			<input type="text" class="input-text sized warranty_field" size="3" name="limited_warranty_length_value" value="
			<?php
			if ( $warranty['type'] == 'included_warranty' ) {
				echo $warranty['value'];}
			?>
	...
	<div class="options_group grouping show_if_addon_warranty hide_if_control_variations">
		<p class="form-field">
			...
			<input type="checkbox" name="addon_no_warranty" id="addon_no_warranty" value="yes" 
			<?php
			if ( isset( $warranty['no_warranty_option'] ) && $warranty['no_warranty_option'] == 'yes' ) {
				echo 'checked';}
			?>
			 class="checkbox warranty_field" />
		</p>
